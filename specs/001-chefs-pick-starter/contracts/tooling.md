...
每项检查所属的阶段：C01 在收尾阶段做全量运行；C02、C03、C05、C06、C08、C09、C10、C11、C13、C14、C15、C17、C21、C22 属于基础阶段，供 US1 使用；C12 属于 US2；C04、C07、C16、C20 属于 US3；C18 属于 US4；C19 属于 US5。全部共 22 项。
